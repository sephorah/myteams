...
** Ex: to receive client_event_thread_reply_received
...
** ex: asking the subscribed users to a team / the list of users in
** a domain
...
/**
** @brief Must be called when you requested a list of channels from the
** server
...
/**
** @brief Must be called when you requested a list of threads
** from the server
...
/**
** @brief Must be called when you requested a list of replies
** from the server
...
** @param message_timestamp The unix timestamp of a private message
** creation
...
/**
** @brief Must be called when the user try to do an action and the
...
** @param channel_description The description of the channel that
** was created
**
** Commands:
** /create "channel_name" "channel_description"
